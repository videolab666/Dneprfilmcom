...
export const PIXEL_PERFECT_SECTIONS: PixelPerfectSectionDefinition[] = [
  ...
  { id: 'live.calculator', page: 'live', pageLabel: 'LIVE', sectionIndex: 5, label: 'LIVE · Калькулятор', description: 'Interactive Calculator / Instant Brief.', interactive: true },
  ...
  { id: 'live.faq', page: 'live', pageLabel: 'LIVE', sectionIndex: 8, label: 'LIVE · FAQ', description: 'Исходный FAQ-аккордеон.', interactive: true },
  ...
  { id: 'video.calculator', page: 'video', pageLabel: 'VIDEO', sectionIndex: 4, label: 'VIDEO · Калькулятор', description: 'Interactive Price Calculator.', interactive: true },
  { id: 'video.faq', page: 'video', pageLabel: 'VIDEO', sectionIndex: 5, label: 'VIDEO · FAQ', description: 'Исходный FAQ видеопродакшна.', interactive: true },
  ...
  { id: 'construction.calculator', page: 'construction', pageLabel: 'CONSTRUCTION', sectionIndex: 5, label: 'Construction · Калькулятор', description: 'Interactive Construction Calculator.', interactive: true },
  ...
  { id: 'construction.faq', page: 'construction', pageLabel: 'CONSTRUCTION', sectionIndex: 7, label: 'Construction · FAQ', description: 'FAQ Accordion.', interactive: true },
  ...
  { id: 'photo.gallery', page: 'photo', pageLabel: 'PHOTO', sectionIndex: 2, label: 'PHOTO · Галерея', description: 'Gallery with Category Filter.', interactive: true },
  { id: 'photo.standards', page: 'photo', pageLabel: 'PHOTO', sectionIndex: 3, label: 'PHOTO · Стандарты', description: 'Why Choose Us / Standards.' },
  { id: 'photo.pricing', page: 'photo', pageLabel: 'PHOTO', sectionIndex: 4, label: 'PHOTO · Пакеты', description: 'Исходная секция пакетов и тарифов.', interactive: true },
  { id: 'photo.booking', page: 'photo', pageLabel: 'PHOTO', sectionIndex: 5, label: 'PHOTO · Booking Form', description: 'Исходная форма бронирования.', interactive: true },
];
