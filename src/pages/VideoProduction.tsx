...
const FEATURED_VIDEO_WORKS_RU = [
  {
    ...
    client: 'Girtech (Дровяные печи и грили)',
    category: 'Продуктовая реклама & Фуд-стилизм',
    description: 'Постановочный рекламный ролик для компактных печей Girtech Bravo. Макропланы приготовления неаполитанской пиццы, сочного стейка, живой огонь и атмосфера теплого загородного отдыха в кругу семьи.',
    icon: <Flame className="w-5 h-5 text-amber-500" />,
    image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&q=80&w=1000',
    tags: ['Кинооптика', 'Макросъемка', 'Фуд-стилист', 'Цветокоррекция DaVinci'],
    results: 'Ролик для международных маркетплейсов и соцсетей с высокой конверсией в предзаказы.'
  },
  {
    id: 'ministry-doors',
    title: 'Міністерство Дверей — Промо-ролик производства',
    client: 'Фабрика «Міністерство Дверей»',
    category: 'Имиджевое видео & Промышленный продакшн',
    description: 'Динамичный фильм о высокотехнологичном производстве входных дверей. Роботизированные сварочные комплексы, лазерная резка металлопроката, автоматические линии покраски и строгий 5-ступенчатый контроль качества.',
    icon: <Factory className="w-5 h-5 text-blue-500" />,
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=1000',
    tags: ['FPV-дрон в цеху', '4K 10-bit', 'Стабилизаторы Ronin', 'Саунд-дизайн станков'],
    results: 'Инструмент для работы с дилерами и экспортерами на строительных выставках.'
  },
  {
    id: 'ulka-dubai',
    title: 'ULKA — Dubai Expo Presentation',
    client: 'ULKA (Beauty Equipment)',
    category: 'Международные выставки & Экспорт',
    description: 'Имиджевый презентационный ролик для выставочного стенда на Dubai Expo. Премиальная подача аппаратов и вытяжек для мастеров индустрии красоты, акцент на эстетику форм, эргономику и европейские сертификаты.',
    icon: <Globe2 className="w-5 h-5 text-indigo-500" />,
    image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1000',
    tags: ['Глянец и минимализм', 'Свет Aputure', 'Английский диктор', 'Motion Graphics'],
    results: 'Привлечение новых дистрибьюторов в странах Ближнего Востока и Европы.'
  },
  {
    id: 'helios-medical',
    title: 'Центр «Геліос» — Медицинское промо',
    client: 'Центр сімейного здоров’я та реабілітації «Геліос»',
    category: 'Медицинский видеопродакшн',
    description: 'Доверительный и технологичный промо-ролик центра реабилитации. Демонстрация роботизированных тренажеров, бережная работа врачей с пациентами, чистая кинематографичная картинка с мягким светом.',
    icon: <Stethoscope className="w-5 h-5 text-emerald-500" />,
    image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=1000',
    tags: ['Интервью врачей', 'Съемка в стерильных зонах', 'Мягкий свет', 'Эмоциональный сценарий'],
    results: 'Увеличение записи на первичные консультации и рост доверия к центру.'
  },
  {
    id: 'hyamax-conf',
    title: 'HYAMAX Conference — Масштабный бизнес-ивент',
    client: 'HYAMAX Aesthetic Academy',
    category: 'Отчетный фильм & Ивент-продакшн',
    description: 'Динамичный репортаж международной косметологической конференции: съемка мастер-классов ведущих пластических хирургов, живые эмоции участников, интервью со спикерами и вечерняя шоу-программа.',
    icon: <Award className="w-5 h-5 text-purple-500" />,
    image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&q=80&w=1000',
    tags: ['3 оператора', 'Интервью на радиомикрофоны', 'Быстрый монтаж', 'Highlight-ролик 24ч'],
    results: 'Мгновенный вирусный охват в Instagram и предварительная распродажа билетов на следующий год.'
  },
  {
    id: 'fit4you',
    title: 'Fit4you — Энергия движения и тренировок',
    client: 'Сеть фитнес-клубов Fit4you',
    category: 'Динамичное промо для ритейла и фитнеса',
    description: 'Взрывное промо с акцентом на драйв, современное силовое оборудование, индивидуальный тренинг и групповые программы Pole Dance. Скоростной монтаж в ритм качающего саундтрека.',
    icon: <Dumbbell className="w-5 h-5 text-rose-500" />,
    image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&q=80&w=1000',
    tags: ['Speed-ramping', 'Slow Motion 120fps', 'Неоновый свет', 'Динамичный монтаж'],
    results: 'Рекламная кампания сезонных абонементов с перевыполнением плана продаж.'
  }
];

const FEATURED_VIDEO_WORKS_UK = [
  {
    id: 'girtech',
    title: 'Advertising — Girtech Bravo',
    client: 'Girtech (Дров\'яні печі та грилі)',
    category: 'Продуктова реклама & Фуд-стилізм',
    description: 'Постановочний рекламний ролик для компактних печей Girtech Bravo. Макроплани приготування неаполітанської піци, соковитого стейка, живий вогонь та атмосфера теплого заміського відпочинку в колі родини.',
    icon: <Flame className="w-5 h-5 text-amber-500" />,
    image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&q=80&w=1000',
    tags: ['Кінооптика', 'Макрозйомка', 'Фуд-стиліст', 'Кольорокорекція DaVinci'],
    results: 'Ролик для міжнародних маркетплейсів та соцмереж з високою конверсією у замовлення.'
  },
  {
    id: 'ministry-doors',
    title: 'Міністерство Дверей — Промо-ролик виробництва',
    client: 'Фабрика «Міністерство Дверей»',
    category: 'Іміджеве відео & Промисловий продакшн',
    description: 'Динамічний фільм про високотехнологічне виробництво вхідних дверей. Роботизовані зварювальні комплекси, лазерний розкрій металопрокату, автоматичні лінії фарбування та строгий 5-ступеневий контроль якості.',
    icon: <Factory className="w-5 h-5 text-blue-500" />,
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=1000',
    tags: ['FPV-дрон у цеху', '4K 10-bit', 'Стабілізатори Ronin', 'Саунд-дизайн верстатів'],
    results: 'Інструмент для роботи з дилерами та експортерами на будівельних виставках.'
  },
  {
    id: 'ulka-dubai',
    title: 'ULKA — Dubai Expo Presentation',
    client: 'ULKA (Beauty Equipment)',
    category: 'Міжнародні виставки & Експорт',
    description: 'Іміджевий презентаційний ролик для виставкового стенда на Dubai Expo. Преміальна подача апаратів і витяжок для майстрів індустрії краси, акцент на естетику форм, ергономіку та європейські сертифікати.',
    icon: <Globe2 className="w-5 h-5 text-indigo-500" />,
    image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1000',
    tags: ['Глянець та мінімалізм', 'Світло Aputure', 'Англійський диктор', 'Motion Graphics'],
    results: 'Залучення нових дистриб\'юторів у країнах Близького Сходу та Європи.'
  },
  {
    id: 'helios-medical',
    title: 'Центр «Геліос» — Медичне промо',
    client: 'Центр сімейного здоров’я та реабілітації «Геліос»',
    category: 'Медичний відеопродакшн',
    description: 'Довірливий і технологічний промо-ролик центру реабілітації. Демонстрація роботизованих тренажерів, дбайлива робота лікарів із пацієнтами, чиста кінематографічна картинка з м\'яким світлом.',
    icon: <Stethoscope className="w-5 h-5 text-emerald-500" />,
    image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=1000',
    tags: ['Інтерв\'ю лікарів', 'Зйомка у стерильних зонах', 'М\'яке світло', 'Емоційний сценарій'],
    results: 'Збільшення запису на первинні консультації та зростання довіри до центру.'
  },
  {
    id: 'hyamax-conf',
    title: 'HYAMAX Conference — Масштабний бізнес-івент',
    client: 'HYAMAX Aesthetic Academy',
    category: 'Звітний фільм & Івент-продакшн',
    description: 'Динамічний репортаж міжнародної косметологічної конференції: зйомка майстер-класів провідних пластичних хірургів, живі емоції учасників, інтерв\'ю зі спікерами та вечірня шоу-програма.',
    icon: <Award className="w-5 h-5 text-purple-500" />,
    image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&q=80&w=1000',
    tags: ['3 оператори', 'Інтерв\'ю на радіомікрофони', 'Швидкий монтаж', 'Highlight-ролик 24г'],
    results: 'Миттєве вірусне охоплення в Instagram та попередній розпродаж квитків на наступний рік.'
  },
  {
    id: 'fit4you',
    title: 'Fit4you — Енергія руху та тренувань',
    client: 'Мережа фітнес-клубів Fit4you',
    category: 'Динамічне промо для рітейлу та фітнесу',
    description: 'Вибухове промо з акцентом на драйв, сучасне силове обладнання, індивідуальний тренінг та групові програми Pole Dance. Швидкісний монтаж у ритм треку, що качає.',
    icon: <Dumbbell className="w-5 h-5 text-rose-500" />,
    image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&q=80&w=1000',
    tags: ['Speed-ramping', 'Slow Motion 120fps', 'Неонове світло', 'Динамічний монтаж'],
    results: 'Рекламна кампанія сезонних абонементів із перевиконанням плану продажів.'
  }
];

const PRODUCTION_STEPS_RU = [
  {
    step: '01',
    title: 'Пре-продакшн',
    subtitle: 'Фундамент будущего ролика',
    desc: 'Разработка креативной идеи, написание покадрового сценария и режиссерской экспликации, раскадровка (storyboard), подбор локаций (скаутинг), кастинг актеров и составление точного тайминга сметы.'
  },
  {
    step: '02',
    title: 'Съемочный процесс',
    subtitle: 'Работа на площадке',
    desc: 'Выезд съемочной группы с кинокамерами Sony FX9 / FX3, парком кинооптики, киносветом Aputure/Nanlite, звукорежиссером на площадке, оператором FPV-дрона и слаженной режиссерской координацией.'
  },
  {
    step: '03',
    title: 'Пост-продакшн',
    subtitle: 'Магия сборки и лоска',
    desc: 'Черновой и чистовой монтаж, профессиональный колор-грейдинг (цветокоррекция) в DaVinci Resolve, многоканальный саунд-дизайн, дикторская озвучка в студии и 2D/3D моушн-графика.'
  },
  {
    step: '04',
    title: 'Адаптация & Передача',
    subtitle: 'Готовые форматы для всех каналов',
    desc: 'Финальный мастер-экспорт в ProRes / 4K H.265, адаптация пропорций под все платформы (16:9 для ТВ и YouTube, 9:16 для Reels/TikTok, 1:1 для соцсетей) с архивной бекап-копией проекта.'
  }
];

const PRODUCTION_STEPS_UK = [
  {
    step: '01',
    title: 'Пре-продакшн',
    subtitle: 'Фундамент майбутнього ролика',
    desc: 'Розробка креативної ідеї, написання покадрового сценарію та режисерської експлікації, розкадрування (storyboard), підбір локацій (скаутинг), кастинг акторів та складання точного таймінгу кошторису.'
  },
  {
    step: '02',
    title: 'Знімальний процес',
    subtitle: 'Робота на майданчику',
    desc: 'Виїзд знімальної групи з кінокамерами Sony FX9 / FX3, парком кінооптики, кіносвітлом Aputure/Nanlite, звукорежисером на майданчику, оператором FPV-дрона та злагодженою режисерською координацією.'
  },
  {
    step: '03',
    title: 'Пост-продакшн',
    subtitle: 'Магія збірки та лоску',
    desc: 'Чорновий і чистовий монтаж, професійний колор-грейдинг (кольорокорекція) у DaVinci Resolve, багатоканальний саунд-дизайн, дикторська озвучка у студії та 2D/3D моушн-графіка.'
  },
  {
    step: '04',
    title: 'Адаптація & Передача',
    subtitle: 'Готові формати для всіх каналів',
    desc: 'Фінальний мастер-експорт у ProRes / 4K H.265, адаптація пропорцій під усі платформи (16:9 для ТБ і YouTube, 9:16 для Reels/TikTok, 1:1 для соцмереж) з архівною бекап-копією проєкту.'
  }
];
