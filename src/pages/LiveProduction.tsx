...
export function LiveProduction() {
  ...
  const [city, setCity] = useState<string>(l("Київ", "Киев"));
    ...
    <div className="w-full bg-slate-50">
      ...
      <div className="bg-slate-900 border-b border-slate-800 text-slate-400 text-xs py-2 px-4">
        <div className="max-w-7xl mx-auto flex items-center space-x-2">
          <Link to="/" className="hover:text-white transition-colors">{l("Головна", "Главная")}</Link>
          <span>/</span>
          <span className="text-indigo-400 font-medium">{l("Рішення", "Решения")}</span>
          <span>/</span>
      ...
      <section className="relative bg-slate-950 text-white overflow-hidden py-24 lg:py-32">
        <div className="absolute inset-0 z-0">
          ...
          <img 
            ...
            alt={l("Режисерський пульт трансляції", "Режиссерский пульт трансляции")} 
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-400/30 text-indigo-300 text-xs font-semibold uppercase tracking-wider mb-6">
              ...
              {l("Флагманський напрямок • LIVE Production", "Флагманское направление • LIVE Production")}
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.1] mb-6">
              {l("Прямі трансляції та ефіри", "Прямые трансляции и эфиры")} <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-sky-300 to-indigo-200">
                {l("без права на помилку", "без права на ошибку")}
              </span>
            </h1>

            <p className="text-lg sm:text-xl text-slate-300 font-light leading-relaxed mb-8">
              {l("Багатокамерна зйомка спортивних змагань, конференцій, форумів та гібридних подій. 100% інженерна надійність, резервний інтернет Starlink, миттєві повтори та ефірна графіка телевізійного рівня.", "Многокамерная съемка спортивных соревнований, конференций, форумов и гибридных событий. 100% инженерная надежность, резервный интернет Starlink, мгновенные повторы и эфирная графика телевизионного уровня.")
              }
            </p>
            ...
            <div className="flex flex-wrap gap-4 items-center mb-12">
              ...
              >
                {l("Розрахувати трансляцію", "Рассчитать трансляцию")} <ArrowRight className="w-4 h-4 ml-2" />
              </a>
              <a 
                href="#behind-scenes" 
              ...
              >
                {l("Інженерія та обладнання", "Инженерия и оборудование")}
              </a>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-slate-800/80 text-left">
              <div>
                <div className="text-2xl font-bold text-white">{l("До 12", "До 12")}</div>
                <div className="text-xs text-slate-400 mt-0.5">{l("Камер в одному ефірі", "Камер в одном эфире")}</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-indigo-400">100%</div>
                <div className="text-xs text-slate-400 mt-0.5">{l("Резервування зв'язку", "Резервирование связи")}</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-white">4K / 60fps</div>
                <div className="text-xs text-slate-400 mt-0.5">{l("Якість майстер-запису", "Качество мастер-записи")}</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-sky-400">&lt; 1 {l("сек", "сек")}</div>
                <div className="text-xs text-slate-400 mt-0.5">{l("Затримка в телемостах", "Задержка в телемостах")}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
              {l("Формати мовлення", "Форматы вещания")}
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4">
              {l("Рішення під будь-які завдання вашого бізнесу", "Решения под любые задачи вашего бизнеса")}
            </h2>
            <p className="text-base sm:text-lg text-slate-600 mt-3">
              {l("Кожен захід має свою специфіку. Ми налаштовуємо техніку та сценарій під ваші цілі.", "Каждое мероприятие имеет свою специфику. Мы настраиваем технику и сценарий под ваши цели.")
              }
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-slate-50 rounded-2xl p-7 border border-slate-200/80 hover:shadow-xl hover:border-indigo-200 transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">{l("Спортивні трансляції", "Спортивные трансляции")}</h3>
                <p className="text-sm text-slate-600 mb-6 leading-relaxed">
                  {l("Динамічні змагання з повільними повторами з кількох ракурсів, інтеграцією спортивного табло, часу та плашок гравців.", "Динамичные соревнования с медленными повторами с нескольких ракурсов, интеграцией спортивного табло, времени и плашек игроков.")
                  }
                </p>
                <ul className="space-y-2.5 text-xs text-slate-700 mb-6">
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Уповільнені повтори (Replay)", "Замедленные повторы (Replay)")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Табло рахунку та часу матчу", "Табло счета и времени матча")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Кабіна коментатора з гарнітурами", "Кабина комментатора с гарнитурами")}</li>
                </ul>
              </div>
              <a href="#calculator" onClick={() => setFormat('sports')} className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center mt-2">
                {l("Сконфігурувати спорт", "Сконфигурировать спорт")} <ArrowRight className="w-3.5 h-3.5 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-7 border border-slate-200/80 hover:shadow-xl hover:border-indigo-200 transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">{l("Конференції та форуми", "Конференции и форумы")}</h3>
                <p className="text-sm text-slate-600 mb-6 leading-relaxed">
                  {l("Трансляція презентацій спікерів із кришталевою чіткістю слайдів, синхронним перекладом та інтеграцією запитань із зали.", "Трансляция презентаций спикеров с кристальной четкостью слайдов, синхронным переводом и интеграцией вопросов из зала.")
                  }
                </p>
                <ul className="space-y-2.5 text-xs text-slate-700 mb-6">
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Захоплення презентацій 1:1 без розмиття", "Захват презентаций 1:1 без размытия")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Синхронний переклад на 2+ мови", "Синхронный перевод на 2+ языка")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Інтерактив: запитання з Telegram/Slido", "Интерактив: вопросы из Telegram/Slido")}</li>
                </ul>
              </div>
              <a href="#calculator" onClick={() => setFormat('conference')} className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center mt-2">
                {l("Сконфігурувати форум", "Сконфигурировать форум")} <ArrowRight className="w-3.5 h-3.5 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-7 border border-slate-200/80 hover:shadow-xl hover:border-indigo-200 transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">{l("Гібридні події та телемости", "Гибридные события и телемосты")}</h3>
                <p className="text-sm text-slate-600 mb-6 leading-relaxed">
                  {l("Об'єднання офлайн-зали з віддаленими спікерами та експертами з усього світу захищеними каналами без затримок.", "Объединение офлайн-зала с удаленными спикерами и экспертами со всего мира по защищенным каналам без задержек.")
                  }
                </p>
                <ul className="space-y-2.5 text-xs text-slate-700 mb-6">
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Підключення через vMix Call / Zoom", "Подключение через vMix Call / Zoom")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Пряме виведення на LED-екрани зали", "Прямой вывод на LED-экраны зала")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Повне придушення відлуння (Acoustic Echo)", "Полное подавление эха (Acoustic Echo)")}</li>
                </ul>
              </div>
              <a href="#calculator" onClick={() => setFormat('corporate')} className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center mt-2">
                {l("Сконфігурувати телеміст", "Сконфигурировать телемост")} <ArrowRight className="w-3.5 h-3.5 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-7 border border-slate-200/80 hover:shadow-xl hover:border-indigo-200 transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">{l("Закриті корпоративні ефіри", "Закрытые корпоративные эфиры")}</h3>
                <p className="text-sm text-slate-600 mb-6 leading-relaxed">
                  {l("Безпечне мовлення для співробітників, акціонерів або закритих клубів із суворим контролем доступу та конфіденційності.", "Безопасное вещание для сотрудников, акционеров или закрытых клубов со строгим контролем доступа и конфиденциальности.")
                  }
                </p>
                <ul className="space-y-2.5 text-xs text-slate-700 mb-6">
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Захист паролем та whitelist доменів", "Защита паролем и whitelist доменов")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Стрімінг на корпоративний портал", "Стриминг на корпоративный портал")}</li>
                  <li className="flex items-center"><CheckCircle2 className="w-4 h-4 text-indigo-600 mr-2 shrink-0" /> {l("Захист від перехоплення та копіювання", "Защита от перехвата и копирования")}</li>
                </ul>
              </div>
              <a href="#calculator" onClick={() => setFormat('corporate')} className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center mt-2">
                {l("Сконфігурувати ефір", "Сконфигурировать эфир")} <ArrowRight className="w-3.5 h-3.5 ml-1" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-400 bg-indigo-950/80 px-3 py-1 rounded-full border border-indigo-800">
              {l("За лаштунками ефіру", "За кулисами эфира")}
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-4">
              {l("Інженерія, якій можна довіряти", "Инженерия, которой можно доверять")}
            </h2>
            <p className="text-base sm:text-lg text-slate-400 mt-3">
              {l("Професійний ефір складається із сотень технічних нюансів. Ми не сподіваємось на удачу — ми вибудовуємо відмовостійкі системи.", "Профессиональный эфир складывается из сотен технических нюансов. Мы не надеемся на удачу — мы выстраиваем отказоустойчивые системы.")
              }
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700">
              ...
              <h3 className="text-lg font-bold text-white mb-2">{l("Резервування зв'язку (Bonding)", "Резервирование связи (Bonding)")}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {l("Супутниковий термінал Starlink + апаратна агрегація 3 незалежних мобільних операторів (Kyivstar, Vodafone, Lifecell). Якщо кабель на майданчику пошкоджено, ефір не зупиниться.", "Спутниковый терминал Starlink + аппаратная агрегация 3 независимых мобильных операторов (Kyivstar, Vodafone, Lifecell). Если кабель на площадке поврежден, эфир не остановится.")
                }
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700">
              ...
              <h3 className="text-lg font-bold text-white mb-2">{l("Режисерські станції vMix & ATEM", "Режиссерские станции vMix & ATEM")}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {l("Потужні мобільні ПТС-станції на базі професійних GPU NVIDIA RTX та мікшерів Blackmagic ATEM Constellation. Швидке перемикання камер, графічні накладення та моментальні титри.", "Мощные мобильные ПТС-станции на базе профессиональных GPU NVIDIA RTX и микшеров Blackmagic ATEM Constellation. Быстрое переключение камер, графические наложения и моментальные титры.")
                }
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700">
              ...
              <h3 className="text-lg font-bold text-white mb-2">{l("Бездротові тракти без затримки", "Беспроводные тракты без задержки")}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {l("Системи бездротової передачі нестиснутого відеосигналу Teradek / Hollyland Cosmos. Оператори вільні у переміщенні залою та стадіоном без ризику заплутатися в кабелях.", "Системы беспроводной передачи несжатого видеосигнала Teradek / Hollyland Cosmos. Операторы свободны в перемещении по залу и стадиону без риска запутаться в кабелях.")
                }
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700">
              ...
              <h3 className="text-lg font-bold text-white mb-2">{l("Службовий зв'язок Intercom", "Служебная связь Intercom")}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {l("Повнодуплексні бездротові гарнітури Hollyland Solidcom із шумозаглушенням та Tally-індикацією. Режисер керує операторами щосекунди, не створюючи шуму на майданчику.", "Полнодуплексные беспроводные гарнитуры Hollyland Solidcom с шумоподавлением и Tally-индикацией. Режиссер управляет операторами каждую секунду, не создавая шума на площадке.")
                }
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700">
              ...
              <h3 className="text-lg font-bold text-white mb-2">{l("Цифровий звуковий тракт", "Цифровой звуковой тракт")}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {l("Мікшери Midas/Behringer X32, мікрофони Sennheiser EW-D. Окреме зведення для інтернет-ефіру та для акустичних систем зали виключає ефект «бочки» та виникнення свисту зворотного зв'язку.", "Микшеры Midas/Behringer X32, микрофоны Sennheiser EW-D. Отдельное сведение для интернет-эфира и для акустических систем зала исключает эффект \"бочки\" и возникновение свиста обратной связи.")
                }
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700">
              ...
              <h3 className="text-lg font-bold text-white mb-2">{l("ДБЖ подвійного перетворення", "ИБП двойного преобразования")}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {l("Уся центральна апаратна заживлена через онлайнові джерела безперебійного живлення (Online UPS). Повний імунітет до стрибків напруги, перешкод та вимкнень електрики.", "Вся центральная аппаратная запитана через онлайновые источники бесперебойного питания (Online UPS). Полный иммунитет к скачкам напряжения, помехам и отключениям электричества.")
                }
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden border-4 border-indigo-400/40 shrink-0 shadow-xl">
              <img 
                ...
                alt={l("Олександр Пітель", "Александр Питель")} 
                className="w-full h-full object-cover"
              />
            </div>
            <div>
              <blockquote className="text-xl sm:text-2xl font-light italic leading-relaxed text-indigo-100">
                {l("«У зйомці кіно або рекламного ролика завжди є можливість зробити другий або третій дубль. У прямому ефірі дублів не буває: глядач бачить усе, що відбувається, у реальному часі. Тому надійність — це не випадковість, а результат математично вивіреної схеми комутації, резервування вузлів та холоднокровності команди.»", "\"В съемке кино или рекламного ролика всегда есть возможность сделать второй или третий дубль. В прямом эфире дублей не бывает: зритель видит все происходящее в реальном времени. Поэтому надежность — это не случайность, а результат математически выверенной схемы коммутации, резервирования узлов и хладнокровия команды.\"")
                }
              </blockquote>
              <div className="mt-4 font-semibold text-white flex items-center">
                <span>{l("Олександр Пітель", "Александр Питель")}</span>
                <span className="mx-2 text-indigo-400">•</span>
                <span className="text-indigo-300 font-normal text-sm">{l("Засновник LIVE & VIDEO Production", "Основатель LIVE & VIDEO Production")}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="calculator" className="py-24 bg-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
              {l("Інтерактивний конфігуратор", "Интерактивный конфигуратор")}
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4">
              {l("Розрахуйте параметри вашої трансляції за 1 хвилину", "Рассчитайте параметры вашей трансляции за 1 минуту")}
            </h2>
            <p className="text-base text-slate-600 mt-2">
              {l("Оберіть конфігурацію вашої події та отримайте миттєвий розрахунок складу сетапу та вартості.", "Выберите конфигурацию вашего события и получите мгновенный расчет состава сетапа и стоимости.")
              }
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200">
              ...
              <div className="mb-8">
                <label className="block text-sm font-bold text-slate-900 mb-3">
                  {l("1. Тип заходу", "1. Тип мероприятия")}
                </label>
              ...
              <div className="mb-8">
                ...
                <p className="text-xs text-slate-500 mt-2">
                  {cameraCount === 1 && (l("Компактний стрім одного спікера або інтерв'ю.", "Компактный стрим одного спикера или интервью."))}
                  {cameraCount === 2 && (l("Загальний план зали + великий план спікера.", "Общий план зала + крупный план спикера."))}
                  {cameraCount === 3 && (l("Класичний стандарт: загальний, середній та великий план + реакція зали.", "Классический стандарт: общий, средний и крупный план + реакция зала."))}
                  {cameraCount >= 4 && (l("Професійне мультикамерне охоплення зі стедікамами та мобільними точками.", "Профессиональный мультикамерный охват со стедикамами и мобильными точками."))}
                </p>
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-bold text-slate-900 mb-3">
                  {l("4. Технічні опції та резервування", "4. Технические опции и резервирование")}
                </label>
                <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-xs sm:text-sm font-semibold text-slate-900">
                          {l("Ефірна графіка та титри", "Эфирная графика и титры")}
                        </div>
                        <div className="text-xs text-slate-500">
                          {l("Плашки спікерів, заставки, таймери, логотипи", "Плашки спикеров, заставки, таймеры, логотипы")}
                        </div>
                      </div>
                    </div>
                  ...
                  <label className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-xs sm:text-sm font-semibold text-slate-900">
                          {l("Уповільнені повтори (Replay)", "Замедленные повторы (Replay)")}
                        </div>
                        <div className="text-xs text-slate-500">
                          {l("Окремий оператор повторів ключових моментів", "Отдельный оператор повторов ключевых моментов")}
                        </div>
                      </div>
                    </div>
                  ...
                  <label className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-xs sm:text-sm font-semibold text-slate-900">
                          {l("Синхронний переклад (2 аудіодоріжки)", "Синхронный перевод (2 аудиодорожки)")}
                        </div>
                        <div className="text-xs text-slate-500">
                          {l("Окремі стрім-потоки під оригінальний звук та перекладача", "Отдельные стрим-потоки под оригинальный звук и переводчика")}
                        </div>
                      </div>
                    </div>
                  ...
                  <label className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-xs sm:text-sm font-semibold text-slate-900">
                          {l("Виведення ефіру на LED-екрани зали", "Вывод эфира на LED-экраны зала")}
                        </div>
                        <div className="text-xs text-slate-500">
                          {l("Передача чистого сигналу без затримки на сцену", "Передача чистого сигнала без задержки на сцену")}
                        </div>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-5 bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200 sticky top-24">
              <h3 className="text-xl font-bold text-slate-900 mb-6">
                {l("Параметри сетапу", "Параметры сетапа")}
              </h3>
              
              <div className="space-y-3.5 pb-6 border-b border-slate-100 text-sm">
                <div className="flex justify-between text-slate-600">
                  <span>{l("Режисерська група:", "Режиссерская группа:")}</span>
                  <span className="font-semibold text-slate-900">{l("Включено", "Включено")}</span>
                </div>
                <div className="flex justify-between text-slate-600">
                ...
                <div className="flex justify-between text-slate-600">
                  <span>{l("Звуковий пульт та мікрофони:", "Звуковой пульт и микрофоны:")}</span>
                  <span className="font-semibold text-slate-900">{l("Включено", "Включено")}</span>
                </div>
                <div className="flex justify-between text-slate-600">
                  <span>{l("Майстер-запис Full HD / 4K:", "Мастер-запись Full HD / 4K:")}</span>
                  <span className="font-semibold text-slate-900">{l("Включено", "Включено")}</span>
                </div>
                <div className="flex justify-between text-slate-600">
                  <span>{l("Місто проведення:", "Город проведения:")}</span>
                  <span className="font-semibold text-slate-900">{city}</span>
                </div>
              </div>

              <div className="pt-6 mb-8">
                <div className="text-xs text-slate-500 mb-1">{l("Орієнтовний бюджет:", "Ориентировочный бюджет:")}</div>
                <div className="text-3xl sm:text-4xl font-extrabold text-indigo-600">
                  {l("від", "от")} {calculateEstimate().toLocaleString('uk-UA')} ₴
                </div>
                <div className="text-xs text-slate-400 mt-1">
                  {l("Точний кошторис формується після узгодження технічного райдера майданчика.", "Точная смета формируется после согласования технического райдера площадки.")
                  }
                </div>
              </div>
              ...
              {submitted ? (
                <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 text-center">
                  ...
                  <h4 className="text-base font-bold text-emerald-900 mb-1">
                    {l("Заявку успішно прийнято!", "Заявка успешно принята!")}
                  </h4>
                  <p className="text-xs text-emerald-700">
                    {l("Олександр Пітель або головний інженер зв'яжеться з вами протягом 30 хвилин для узгодження дати та деталей.", "Александр Питель или главный инженер свяжется с вами в течение 30 минут для согласования даты и деталей.")
                    }
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmitBrief} className="space-y-3">
                  <div>
                    <input 
                      type="text" 
                      required
                      placeholder={l("Ваше ім'я *", "Ваше имя *")} 
                      value={clientName}
                  ...
                  <div>
                    <input 
                      type="tel" 
                      required
                      placeholder={l("Номер телефону *", "Номер телефона *")} 
                      value={clientPhone}
                  ...
                  <div>
                    <input 
                      type="email" 
                      placeholder={l("Електронна пошта (для кошторису)", "Электронная почта (для сметы)")} 
                      value={clientEmail}
                  ...
                  >
                    {submitting 
                      ? (l("Надсилання...", "Отправка...")) 
                      : (l("Забронювати дату та отримати кошторис", "Забронировать дату и получить смету"))
                    }
                  </button>
                  <p className="text-[11px] text-center text-slate-400">
                    {l("Натискаючи кнопку, ви погоджуєтеся на обробку контактних даних.", "Нажимая кнопку, вы соглашаетесь на обработку контактных данных.")
                    }
                  </p>
                </form>
              )}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
                {l("Досвід в ефірі", "Опыт в эфире")}
              </span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4">
                {l("Реалізовані проекти трансляцій", "Реализованные проекты трансляций")}
              </h2>
            </div>
            <Link to="/cases" className="text-sm font-semibold text-indigo-600 hover:text-indigo-800 flex items-center mt-4 md:mt-0">
              {l("Дивитися всі кейси продакшену", "Смотреть все кейсы продакшена")} <ArrowRight className="w-4 h-4 ml-1" />
            </Link>
          </div>
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 flex flex-col">
              <div className="aspect-[16/10] relative overflow-hidden bg-slate-900">
                <img 
                  ...
                  alt={l("Футбольний матч трансляція", "Футбольный матч трансляция")} 
                ...
                <span className="absolute top-3 left-3 bg-red-600 text-white text-[11px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider">
                  {l("Спорт • 6 камер", "Спорт • 6 камер")}
                </span>
              </div>
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">
                    {l("Всеукраїнський турнір з футболу", "Всеукраинский турнир по футболу")}
                  </h3>
                  <p className="text-xs sm:text-sm text-slate-600 mb-4 leading-relaxed">
                    {l("Два дні безперервного мовлення, 6 камер з повторами спірних моментів (VAR), інтеграція рахунку матчу та коментаторська позиція.", "Два дня непрерывного вещания, 6 камер с повторами спорных моментов (VAR), интеграция счета матча и комментаторская позиция.")
                    }
                  </p>
                </div>
                <div className="pt-4 border-t border-slate-200/80 flex items-center justify-between text-xs text-slate-500">
                  <span>{l("Аудиторія: 45 000+", "Аудитория: 45 000+")}</span>
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 flex flex-col">
              <div className="aspect-[16/10] relative overflow-hidden bg-slate-900">
                <img 
                  ...
                  alt={l("Бізнес-форум трансляція", "Бизнес-форум трансляция")} 
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                />
                <span className="absolute top-3 left-3 bg-indigo-600 text-white text-[11px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider">
                  {l("Форум • 4 камери", "Форум • 4 камеры")}
                </span>
              </div>
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">
                    {l("Міжнародний IT & Tech Forum", "Международный IT & Tech Forum")}
                  </h3>
                  <p className="text-xs sm:text-sm text-slate-600 mb-4 leading-relaxed">
                    {l("Синхронний переклад англійською мовою, захоплення слайдів презентацій у 4K, телеміст зі спікерами з Великої Британії та Німеччини.", "Синхронный перевод на английский язык, захват слайдов презентаций в 4K, телемост со спикерами из Великобритании и Германии.")
                    }
                  </p>
                </div>
                <div className="pt-4 border-t border-slate-200/80 flex items-center justify-between text-xs text-slate-500">
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 flex flex-col">
              <div className="aspect-[16/10] relative overflow-hidden bg-slate-900">
                <img 
                  ...
                  alt={l("Корпоративний саміт", "Корпоративный саммит")} 
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                />
                <span className="absolute top-3 left-3 bg-emerald-600 text-white text-[11px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider">
                  {l("Корпоратив • Закритий ефір", "Корпоратив • Закрытый эфир")}
                </span>
              </div>
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">
                    {l("Щорічний саміт агрохолдингу", "Ежегодный саммит агрохолдинга")}
                  </h3>
                  <p className="text-xs sm:text-sm text-slate-600 mb-4 leading-relaxed">
                    {l("Захищений ефір для 3 500 співробітників по всій країні. Інтерактивні голосування, телемости між 4 філіями та 100% аптайм.", "Защищенный эфир для 3 500 сотрудников по всей стране. Интерактивные голосования, телемосты между 4 филиалами и 100% аптайм.")
                    }
                  </p>
                </div>
                <div className="pt-4 border-t border-slate-200/80 flex items-center justify-between text-xs text-slate-500">
                  <span>Starlink {l("Резерв", "Резерв")}</span>
                  <span className="font-semibold text-slate-800">{l("Корпоративний плеєр", "Корпоративный плеер")}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
              {l("Регламент підготовки", "Регламент подготовки")}
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4">
              {l("Як ми готуємося до вашого ефіру", "Как мы готовимся к вашему эфиру")}
            </h2>
            <p className="text-base text-slate-600 mt-3">
              {l("Чіткий покроковий процес виключає будь-які несподіванки під час відповідального заходу.", "Четкий пошаговый процесс исключает любые неожиданности во время ответственного мероприятия.")
              }
            </p>
          </div>
      ...
      <section className="py-24 bg-white border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
              {l("Питання та відповіді", "Вопросы и ответы")}
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4">
              {l("Часті запитання щодо трансляцій", "Часто задаваемые вопросы по трансляциям")}
            </h2>
          </div>
      ...
      <section className="py-20 bg-slate-950 text-white relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-6">
            {l("Плануєте захід? Давайте обговоримо технічне завдання", "Планируете мероприятие? Давайте обсудим техническое задание")
            }
          </h2>
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto font-light mb-8">
            {l("Залиште заявку або зателефонуйте нам. Ми безкоштовно проведемо попередній аудит майданчика та підготуємо детальну специфікацію обладнання.", "Оставьте заявку или позвоните нам. Мы бесплатно проведем предварительный аудит площадки и подготовим подробную спецификацию оборудования.")
            }
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {l("Перейти до калькулятора", "Перейти к калькулятору")}
            </a>
            <Link 
              to="/contacts" 
            ...
            >
              {l("Зв'язатися з продакшеном", "Связаться с продакшеном")}
            </Link>
          </div>
        </div>
      </section>
